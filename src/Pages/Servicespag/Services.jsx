                        ...
                        {cards.map((card, index) => (
                            ...
                            >
                                ...
                                <div className="absolute top-[300px] left-[20px]">
                                    <motion.h1
                                        className="font-Roboto font-bold text-[28px] leading-[36px] tracking-[0px] text-white"
                                        initial={{ opacity: 0 }}
                                        animate={{ opacity: 1 }}
                                    ...
                                    <motion.p
                                        className="font-Inter font-normal text-[16px] leading-[24px] tracking-[0%] mt-2 text-white"
                                        initial={{ opacity: 0 }}
                                        animate={{ opacity: 1 }}
